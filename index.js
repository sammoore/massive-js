 ...
 * pg-promise.
 */
class Massive extends Database {

  constructor(connection, loaderConfig = {}, driverConfig = {}) {
    ...
    super(connection, loaderConfig, driverConfig);
  }
}
 ...
 */
async function massive(connection, loaderConfig = {}, driverConfig = {}) {
  return (new Massive(connection, loaderConfig, driverConfig)).reload();
}
